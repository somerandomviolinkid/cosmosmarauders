...
data merge block 69 -27 -81 {Command:"function game:upgrades/greenteam/engine2"}

tellraw @a[team=greenTeam] {"text":"Your ship engine has been upgraded to level 1. Please die to gain permanent better attack damage."}