...
data merge block 69 -27 -81 {Command:"function game:upgrades/greenteam/engine3"}

tellraw @a[team=greenTeam] {"text":"Your ship engine has been upgraded to level 2. Please die to gain permanent melee knockback."}
