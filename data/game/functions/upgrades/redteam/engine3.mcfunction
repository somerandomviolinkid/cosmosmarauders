...
data merge block -81 -28 -69 {Command:"say @p is stupid"}
data merge block -81 -27 -69 {Command:""}

tellraw @a[team=redTeam] {"text":"Your ship engine has been upgraded to level 3. Please die to gain even more permanent melee damage."}