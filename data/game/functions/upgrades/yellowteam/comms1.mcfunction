...
data merge block -81 -27 69 {Command:"function game:upgrades/yellowteam/comms2"}

tellraw @a[team=yellowTeam] {"text":"Your ship comms have been upgraded to level 1. Please die to gain permament bow damage."}