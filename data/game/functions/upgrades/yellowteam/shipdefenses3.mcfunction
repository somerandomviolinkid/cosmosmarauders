item replace block -2 10 0 container.1 with diamond_chestplate{display:{Name:'["",{"text":"Space Suit","italic":false}]'},Enchantments:[{lvl:1,id:vanishing_curse},{lvl:1,id:binding_curse}],Unbreakable:1}
...
tellraw @a[team=yellowTeam] {"text":"Your ship defenses have been upgraded to level 3. Please die to gain permanent protection 1 diamond armor."}
